...
void GADUSetRequestConfiguration(GADUTypeRequestConfigurationRef requestConfiguration,
                                 BOOL tagForUnderAgeOfConsent, BOOL tagForChildDirectedTreatment) {
...
/// Returns MobileAds RequestConfiguration
GADUTypeRequestConfigurationRef GADUGetRequestConfiguration() {
